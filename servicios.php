...
<body>
	...
	<!--/navbar-->
	<section id="form" class="fondo-ser">
		...
		<div class="container" id="superior" >
			...
			<div class="container-fluid">
				...
				<img src="assets/img/servi-img.png" alt=" " id="img-serv"> 
			...
			<div class="container-fluid" id="fondo-fcontac">
		 		 <form id="fcontact-ser" class="">
                   ...
                   <div class="input-group">
                    ...
                    <div class="input-group">
		 		 	 	 <span class="input-group-addon">Servicios Electricos:</span>
